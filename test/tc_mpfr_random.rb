...
class TcMpfrRandom < MiniTest::Test
  ...
  def test_urandom_with_prec
    ...
    g2 = [
      GMP::F("0.44905442779", 32), GMP::F("0.88489733171", 32), GMP::F("0.39714318491", 32),
      GMP::F("0.19476944383", 32), GMP::F("0.30126355984", 32), GMP::F("0.22586148360", 32),
      GMP::F("0.67203788180", 32), GMP::F("0.11863605876", 32), GMP::F("0.54191642813", 32)
    ]
    g2.size.times do |i|
